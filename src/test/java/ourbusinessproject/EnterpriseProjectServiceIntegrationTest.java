...
public class EnterpriseProjectServiceIntegrationTest {
    ...
    public void setUp() {
        ...
        project.setEntreprise(enterprise);
    ...
    public void testSaveValidProjectWithNewEnterprise() {
        ...
        assertThat(project.getEntreprise().getId(), is(notNullValue()));
    ...
    public void testFindAllProjectsFromInitialization() {
        ...
        assertThat(projects.get(0).getEntreprise().getName(), is(initializationService.getEntreprise1().getName()));
        assertThat(projects.get(1).getEntreprise().getName(), is(initializationService.getEntreprise2().getName()));
        assertThat(projects.get(2).getEntreprise().getName(), is(initializationService.getEntreprise1().getName()));
