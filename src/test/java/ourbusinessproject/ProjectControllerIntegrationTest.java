...
public class ProjectControllerIntegrationTest {
    ...
    public void testFindAllProjectsWithEnterprises() {
        ...
        assertThat(body, containsString(initializationService.getEntreprise1().getName()));
        assertThat(body, containsString(initializationService.getEntreprise2().getName()));
